...
export PATHBKP=/backup/oracle/${ORACLE_SID}
...
backup_logico_pump() {
  ...
  expdp $orausr/$orapwd@${ORACLE_SID} full=y exclude=schema:\"= \'RESTORE_PROT\'\" directory=data_pump_dir_${ORACLE_SID} \
...
#Acrescimo feito pelo DBA Andre em 02_09_11
  ...
  rm -f /u04/oracle/backup/MMADSV/adump/*
  rm -f /u04/oracle/backup/MMADSV/archive/*
  rm -f /u04/oracle/backup/MMADSV/bdump/*
  rm -f /u04/oracle/backup/MMADSV/dpdump/*
  rm -f /u04/oracle/backup/MMADSV/export/*
  #rm -f /u04/oracle/backup/MMADSV/sql/${operation}*
  rm -f /u04/oracle/backup/MMADSV/udump/*
